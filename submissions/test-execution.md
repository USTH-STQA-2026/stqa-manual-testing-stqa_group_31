...
> **N/T** = Not Tested (system behavior could not be fully verified due to test environment state)
...
| REQ-02 | 2 | 2 | 0 | ✅ Full |
| REQ-03 | 3 | 3 | 0 | ✅ Full |
| REQ-04 | 6 | 4 | 1 (TC-13) | ⚠️ Bug found |
| REQ-05 | 2 | 1 | 1 (TC-17) | ⚠️ Bug found |
| REQ-06 | 2 | 2 | 0 | ✅ Full |
| REQ-07 | 4 | 2 | 2 (TC-21, TC-22) | ⚠️ Bugs found |
| REQ-08 | 4 | 4 | 0 | ✅ Full |
| **Total** | **27** | **22** | **4** | **8/8 REQ tested** |

> Note: TC-14 and TC-15 marked PASS based on observed UI behaviour (borrow button disabled for suspended/expired accounts). Full error message verification was limited by system state during testing.
